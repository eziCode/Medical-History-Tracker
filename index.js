...
const RetrieveIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'RetrieveIntent';
    },
    handle(handlerInput) {
        const { requestEnvelope, responseBuilder } = handlerInput;
         const name = Alexa.getSlotValue(requestEnvelope, 'name');
        let number_of_days = Alexa.getSlotValue(requestEnvelope, 'number_of_days');
        let number_of_weeks = Alexa.getSlotValue(requestEnvelope, 'number_of_weeks');
        let number_of_months = Alexa.getSlotValue(requestEnvelope, 'number_of_months');
